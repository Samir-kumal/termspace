...
describe('WorkspaceSidebar', () => {
  it('renders all workspace names', () => {
    render(<WorkspaceSidebar onAddWorkspace={vi.fn()} onSelectWorkspace={vi.fn()} />)
  ...
  it('calls onSelectWorkspace with the workspace id when clicked', () => {
    ...
    render(<WorkspaceSidebar onAddWorkspace={vi.fn()} onSelectWorkspace={onSelect} />)
  ...
  it('calls onAddWorkspace when the + button is clicked', () => {
    const onAdd = vi.fn()
    render(<WorkspaceSidebar onAddWorkspace={onAdd} onSelectWorkspace={vi.fn()} />)
